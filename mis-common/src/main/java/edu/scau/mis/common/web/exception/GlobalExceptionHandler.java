...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResult<String>> handleServiceException(ServiceException e, HttpServletRequest request) {
        String requestURI = request.getRequestURI();
        log.error("请求地址:'{}',发生业务逻辑错误:'{}'", requestURI, e.getMessage());
